package edu.aku.hassannaqvi.sero22hhlisting.models;
...
import edu.aku.hassannaqvi.sero22hhlisting.BR;
...
public class Child extends BaseObservable {
    ...
    // SECTION VARIABLES
    private String sChild = StringUtils.EMPTY;
 ...
 */
    ...
    public Child Hydrate(Cursor cursor) throws JSONException {
        this.id = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_ID));
        this.uid = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_UID));
        this.uuid = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_UUID));
        this.userName = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_USERNAME));
        this.sysDate = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_SYSDATE));
        this.deviceId = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_DEVICEID));
        this.deviceTag = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_DEVICETAGID));
        this.appver = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_APPVERSION));
        this.iStatus = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_ISTATUS));
        this.synced = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_SYNCED));
        this.syncDate = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_SYNCED_DATE));
        this.endTime = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_END_TIME));
        this.startTime = cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_START_TIME));
        sChildHydrate(cursor.getString(cursor.getColumnIndexOrThrow(TableContracts.ChlidTable.COLUMN_SCHILD)));


        return this;
    }

    public void sChildHydrate(String string) throws JSONException {
    ...
    public String sChildtoString() throws JSONException {
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(TableContracts.ChlidTable.COLUMN_ID, this.id);
        json.put(TableContracts.ChlidTable.COLUMN_UID, this.uid);
        json.put(TableContracts.ChlidTable.COLUMN_UUID, this.uuid);
        json.put(TableContracts.ChlidTable.COLUMN_USERNAME, this.userName);
        json.put(TableContracts.ChlidTable.COLUMN_APPVERSION, this.appver);
        json.put(TableContracts.ChlidTable.COLUMN_SYSDATE, this.sysDate);
        json.put(TableContracts.ChlidTable.COLUMN_DEVICEID, this.deviceId);
        json.put(TableContracts.ChlidTable.COLUMN_DEVICETAGID, this.deviceTag);
        json.put(TableContracts.ChlidTable.COLUMN_ISTATUS, this.iStatus);
        json.put(TableContracts.ChlidTable.COLUMN_SYNCED, this.synced);
        json.put(TableContracts.ChlidTable.COLUMN_SYNCED_DATE, this.syncDate);
        json.put(TableContracts.ChlidTable.COLUMN_SCHILD, new JSONObject(sChildtoString()));
        json.put(TableContracts.ChlidTable.COLUMN_END_TIME, this.endTime);
        json.put(TableContracts.ChlidTable.COLUMN_START_TIME, this.startTime);
