...
import static edu.aku.hassannaqvi.sero22hhlisting.core.MainApp.TAJIKISTAN;
...
import edu.aku.hassannaqvi.sero22hhlisting.databinding.ActivityLoginBinding;
...
//                folder = new File(activity.getExternalFilesDir("Backups"), File.separator);
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.sero22hhlisting.ui.SyncActivity.class).putExtra("login", true));
        } else {
